...
const translations = {
  en: {
    ...
    "home.ask_question":
      "Ask about crop management, pest control, irrigation timing, or any farming question...",
    ...
    "home.footer_text":
      "Smart Farming Dashboard - Empowering farmers with AI-driven agricultural intelligence",
    // Chat
    ...
    "chat.plant_disease_description":
      "Upload or capture a photo of your plant to identify diseases and get AI-powered treatment recommendations.",
    ...
    "home.stress_due_weather":
      "for any signs of stress due to current weather patterns",
  ...
  ml: {
    ...
    "home.subtitle":
      "തത്സമയ കാലാവസ്ഥ, മണ്ണ് വിശകലനം, വ്യക്തിഗത കാർഷിക നിർദ്ദേശങ്ങൾ എന്നിവയുള്ള AI-പവർഡ് കാർഷിക ബുദ്ധിമത്ത",
    ...
    "home.ask_question":
      "വിള മാനേജ്മെന്റ്, കീട നിയന്ത്രണം, ജലസേചന സമയം അല്ലെങ്കിൽ ഏതെങ്കിലും കാർഷിക ചോദ്യത്തെക്കുറിച്ച് ചോദിക്കുക...",
    ...
    "home.footer_text":
      "സ്മാർട്ട് ഫാർമിംഗ് ഡാഷ്ബോർഡ് - AI-ഡ്രിവൻ കാർഷിക ബുദ്ധിമത്തയുള്ള കർഷകരെ ശാക്തീകരിക്കുന്നു",
    // Chat
    "chat.title": "അഗ്രിസെൻസ് AI അസിസ്റ്റന്റ്",
    "chat.subtitle": "നിങ്ങളുടെ കൃഷി കൂട്ടാളി",
    "chat.welcome_title": "അഗ്രിസെൻസിലേക്ക് സ്വാഗതം!",
    "chat.welcome_text":
      "കൃഷി, വിളകൾ, കാലാവസ്ഥ, അല്ലെങ്കിൽ കാർഷിക രീതികൾ എന്നിവയെക്കുറിച്ച് എന്തെങ്കിലും ചോദിക്കുക. ഞാൻ സഹായിക്കാൻ ഇവിടെയുണ്ട്!",
    "chat.placeholder":
      "വിളകൾ, കാലാവസ്ഥ, വിപണികൾ എന്നിവയെക്കുറിച്ച് ചോദിക്കുക...",
    "chat.send": "അയയ്ക്കുക",
    "chat.play": "പ്ലേ",
    "chat.stop": "നിർത്തുക",
    ...
    "chat.camera_error":
      "ക്യാമറയ്ക്ക് HTTPS ആവശ്യമാണ്. പകരം ഫയൽ അപ്‌ലോഡ് ഉപയോഗിക്കുക.",
    "chat.plant_disease_detection": "സസ്യ രോഗ കണ്ടെത്തൽ",
    "chat.plant_disease_description":
      "രോഗങ്ങൾ തിരിച്ചറിയാനും AI-പവർഡ് ചികിത്സാ നിർദ്ദേശങ്ങൾ നേടാനും നിങ്ങളുടെ ചെടിയുടെ ഫോട്ടോ അപ്‌ലോഡ് ചെയ്യുക അല്ലെങ്കിൽ ക്യാപ്‌ചർ ചെയ്യുക.",
    "chat.upload_or_capture":
      "ഗാലറിയിൽ നിന്ന് അപ്‌ലോഡ് ചെയ്യുക അല്ലെങ്കിൽ ക്യാമറ ഉപയോഗിച്ച് ക്യാപ്‌ചർ ചെയ്യുക",
    // Officer
    ...
    "home.stress_due_weather":
      "കാലാവസ്ഥാ വ്യതിയാനങ്ങളുടെ കാരണത്താൽ സമ്മർദ്ദത്തിന്റെ ലക്ഷണങ്ങൾക്കായി",
    ...
    "home.current_conditions_suitable":
      "നിലവിലെ സാഹചര്യങ്ങൾ മിക്ക കാർഷിക പ്രവർത്തനങ്ങൾക്കും വിള വളർച്ചയ്ക്കും അനുയോജ്യമാണ്.",
    "home.footer_dashboard":
      "സ്മാർട്ട് ഫാർമിംഗ് ഡാഷ്ബോർഡ് - AI-ഡ്രിവൻ കാർഷിക ബുദ്ധിമത്തയുള്ള കർഷകരെ ശാക്തീകരിക്കുന്നു",
    ...
    "soil.nitrogen_desc":
      "ഇലകളുടെ വളർച്ചയ്ക്കും ക്ലോറോഫിൽ ഉൽപാദനത്തിനും അത്യാവശ്യം",
    "soil.phosphorus_desc": "വേരുകളുടെ വികാസത്തിനും പൂവിടുന്നതിനും പ്രധാനം",
    "soil.potassium_desc":
      "രോഗ പ്രതിരോധവും ഫലത്തിന്റെ ഗുണനിലവാരവും വർധിപ്പിക്കുന്നു",
    ...
    "ai.monitor_fungal_diseases":
      "ഉയർന്ന ഈർപ്പം കാരണം ഫംഗൽ രോഗങ്ങൾ നിരീക്ഷിക്കുക",
